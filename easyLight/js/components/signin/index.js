...
class SignIn extends Component {
  ...
  sendData () {
    ...
    this.createdAccountValidation()
  }
  validateEmail () {
    AlertIOS.alert(
     'Verificación de email',
     'El correo ya esta asociado a una cuenta existente',
      [
        {text: 'OK',
          onPress: () => {
            this.setState({
  ...
  createdAccountValidation () {
    if (this.props.emailValidation === '') {
      ...
      if (Platform.OS === 'ios') {
        AlertIOS.alert(
          'Felicidades',
         'Tu cuenta se a creado satisfactoriamente',
          [
          ...
          <Grid>
            ...
            <Col>
              <Form>
                ...
                <Item inlineLabel last style={styles.form__item}>
                  ...
                  <Input
                    ...
                    onBlur={() => {
                      ...
                      } else if (this.props.emailValidation !== '') {
                        this.setState({
                          isValidEmail: require('../../../images/Failure.png')
                        })
                      } else {
                ...
                <Item inlineLabel last style={styles.form__item}>
                  <Label style={{ paddingLeft: 10, marginLeft: (Screen.width === 320)? 20 : 30 , fontSize: (Screen.width === 320) && 15 }}>F. nacimiento<Text style={{color: 'red', paddingBottom: 10}}>*</Text>:</Label>
...
const mapStateToProps = state => ({
  emailValidation: state.user.createAccountValidation
})
